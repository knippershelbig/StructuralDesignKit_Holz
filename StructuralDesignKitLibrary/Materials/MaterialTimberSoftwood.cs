...
namespace StructuralDesignKitLibrary.Materials
{
    ...
    public class MaterialTimberSoftwood : IMaterial, IMaterialTimber
    {
        ...
        public MaterialTimberSoftwood(string name)
        {
            ...
            Fc90k = MaterialTimberSoftwood.fmzk[Grade];
            Fvk = MaterialTimberSoftwood.fmzk[Grade];
            Frk = MaterialTimberSoftwood.fmzk[Grade];
            E0mean = MaterialTimberSoftwood.fmzk[Grade];
            E90mean = MaterialTimberSoftwood.fmzk[Grade];
            G0mean = MaterialTimberSoftwood.fmzk[Grade];
            E0_005 = MaterialTimberSoftwood.fmzk[Grade];
            G0_005 = MaterialTimberSoftwood.fmzk[Grade];
            RhoMean = MaterialTimberSoftwood.fmzk[Grade];
            RhoK = MaterialTimberSoftwood.fmzk[Grade];
