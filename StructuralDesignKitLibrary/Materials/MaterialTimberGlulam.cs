...
namespace StructuralDesignKitLibrary.Materials
{
    public class MaterialTimberGlulam : IMaterial, IMaterialTimber
    {
        ...
        public MaterialTimberGlulam(string name)
        {
            ...
            Fc90k = MaterialTimberGlulam.fmzk[Grade];
            Fvk = MaterialTimberGlulam.fmzk[Grade];
            Frk = MaterialTimberGlulam.fmzk[Grade];
            E0mean = MaterialTimberGlulam.fmzk[Grade];
            E90mean = MaterialTimberGlulam.fmzk[Grade];
            G0mean = MaterialTimberGlulam.fmzk[Grade];
            E0_005 = MaterialTimberGlulam.fmzk[Grade];
            G0_005 = MaterialTimberGlulam.fmzk[Grade];
            RhoMean = MaterialTimberGlulam.fmzk[Grade];
            RhoK = MaterialTimberGlulam.fmzk[Grade];
